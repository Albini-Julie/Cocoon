<template>
  ...
  <div class="ml-[5rem] mt-5 flex items-center">
    ...
    <div class="flex flex-col">
      ...
      <p class="mx-2 mt-5 font-work-sans text-[14px]">
        Avec Cocoon, pas de coûts de transport, de baby-sitting, ou de restauration sur place !
      </p>
    </div>
  </div>
  ...
  <div class="mr-[5rem] mt-5 flex items-center">
    <div class="flex flex-col">
      ...
      <div class="flex flex-col">
        <p class="font-work-sans text-[14px]">
          Pas de perte de temps sur les routes : mettez votre casque et l’expérience peut commencer !
        </p>
        <p class="font-work-sans text-[14px]">
